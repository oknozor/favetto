...
//!
//! Both the client and the daemon speak the same wire format over WebSocket: a
//! [`Frame`] travels as a single binary (or text) message carrying its msgpack
//! encoding, and a Close message ends the stream.
//!
